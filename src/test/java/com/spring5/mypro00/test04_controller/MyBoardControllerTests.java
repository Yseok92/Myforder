...
@WebAppConfiguration  //DispatcherServlet의 구성 설정 파일을 사용하여 컨트롤러를 테스트하기 위해 필요한 설정 // DispatcherServlet이 사용하는 bean 구성 파일 
...
//    @Setter(onMethod_ = { @Autowired })
    ...
    private MockMvc mockMvc; //Mock - 가상의
...
//                                 ) // 가상 브라우저 환경에서 get 방식으로 요청을 수행해라
//        							// 브라우저가 있는 것처럼 mocMvc가 처리
//                        .andReturn()
//                        .getModelAndView()
////                        .getViewName());
//                        .getModelMap());
