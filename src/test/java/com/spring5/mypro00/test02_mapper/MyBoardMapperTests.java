...
//    	myBoardMapper.selectMyBoard().forEach(myBoard -> log.info(myBoard));
//    }
...
//      myBoardMapper.insertMyBoard(myBoard);
//      log.info("Mapper 처리 후 VO: " + myBoard);
//  }
...
//  }
//
//  //게시물 삭제 테스트 - 실제 특정 게시물이 삭제됨 (30)
//  @Test
//  public void testDeleteMyBoard() {
//      log.info("DELETE COUNT: " + myBoardMapper.deleteMyBoard(30L));
...
//	@Test
//	public void testSelectMyBoard() {
//		log.info("SELECT TUPLEL " + myBoardMapper.selectMyBoard(1L));
//	}
