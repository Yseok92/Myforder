...
<form class="form-inline" id="frmSendValue" name="frmSendValue" action="${contextPath }/myboard/list" method="get" >
	<div class="form-group">
		...
		<div class="input-group"><!-- 검색 초기화 버튼 -->
			<button id="btnReset" class="btn btn-info" type="button">초기화</button>
		</div> 
	
		<input type="hidden" name="pageNum" id="pageNum" value="${pagingCreator.myboardPaging.pageNum }" >
<%-- <input type="hidden" name="rowAmountPerPage" id="rowAmountPerPage" value="${pagingCreator.myboardPaging.rowAmountPerPage }" > --%>
...
$(document).ready(function(){
	...
	window.addEventListener("popstate", function(event){x
